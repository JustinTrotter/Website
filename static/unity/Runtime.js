...
assert((6089872) % 16 === 0, 'heap must start aligned to 16 bytes, DYNAMIC_BASE==' + 6089872);
...
var HEAPF64 = new Float64Array(buffer);
  ...
  HEAP32[DYNAMICTOP_PTR>>2] = 6089872;
...
// {{PRE_LIBRARY}}
  ...
  var _fetch_work_queue=846960;function __emscripten_get_fetch_work_queue() {
...
env['table'] = new WebAssembly.Table({ 'initial': 6775
  , 'maximum': 6775
  , 'element': 'anyfunc' });
